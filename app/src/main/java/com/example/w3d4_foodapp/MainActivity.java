...
//TODO: 10. FoodItemClickListener ı implements
//TODO: 11. public void onItemClicked(FoodModel foodModel) impelement ettik
public class MainActivity extends AppCompatActivity implements FoodsAdapter.FoodItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodModelArrayList.add(new FoodModel("Tavuk Sote","25 dk",R.drawable.ic_tavukl_sote,"Yarım kg tavuk göğsü\n" +
                ...
                "Tuz\n" +
                "1 su bardağı su"));
        foodModelArrayList.add(new FoodModel("Taze Fasulye","40 dk",R.drawable.ic_fasulye,"600 gr taze yeşil fasulye (çalı fasulye kullandım)\n" +
                "2 adet domates\n" +
                "1 adet soğan\n" +
